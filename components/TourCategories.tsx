      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-14">
          ...
          <div className="flex-shrink-0 md:pt-2">
            <button className="w-12 h-12 rounded-full bg-[#1A2B2B] flex items-center justify-center hover:bg-[#2EC98A] transition-colors duration-300">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          {categories.map((cat, i) => (
            ...
            >
              <Image src={cat.image} alt={cat.name} fill className="object-cover transition-transform duration-700 group-hover:scale-105" unoptimized />
        ...
        <div className="flex gap-3 mt-8 justify-end">
          <button className="w-10 h-10 rounded-full border border-[#1A2B2B]/20 hover:border-[#2EC98A] hover:text-[#2EC98A] flex items-center justify-center text-[#1A2B2B] transition-all duration-300">
