  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#1A2B2B] mt-3 mb-4">Tour Categories</h2>
        <p className="text-[#6B7B7B] max-w-2xl mx-auto">From ancient temples to pristine beaches, choose your perfect Sri Lankan adventure</p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        {categories.map((cat) => (
          <div key={cat.name} className="group relative overflow-hidden rounded-2xl cursor-pointer h-48 md:h-64">
            <Image src={cat.image} alt={cat.name} fill className="object-cover transition-transform duration-700 group-hover:scale-110" unoptimized />
