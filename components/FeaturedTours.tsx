      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div>
            ...
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#1A2B2B] mt-3">
              Featured Tour Packages
            </h2>
          </div>
          <button className="text-[#2EC98A] border border-[#2EC98A]/50 hover:bg-[#2EC98A]/10 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 whitespace-nowrap">
            View All Tours →
          </button>
        </div>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[#E2F5F0]">
                  <div>
                    ...
                    <div className="text-[#2EC98A] font-bold text-lg">
                      {tour.price} <span className="text-[#6B7B7B] text-xs font-normal">/ person</span>
                    </div>
                  </div>
